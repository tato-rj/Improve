<section class="container mb-6">
	<div class="row">
		<div class="col-lg-6 col-12 mb-3 px-4 pb-4 text-center">
		...
		<div class="col-lg-8 col-12 mx-auto text-center">
			<p class="lead text-primary text-uppercase d-inline-block"><strong>@lang('Nothing can be more gratifying to an athlete than having everything you need to unlock greatness in one place!')</strong></p>
		</div>
	</div>
</section>